...
namespace Common.Logs.Refs
{
    ...
    public interface ISimpleLogFactory
    {
        ...
        Func<CreateSimpleLogArgs, ISimpleLog> CreateSimpleLogFunc { get; set; }
    }
    
    public class CreateSimpleLogArgs
    {
        public string Category { get; set; }
    ...
    public class SimpleLogFactory : ISimpleLogFactory
    {
        public SimpleLogFactory(SimpleLogSettings settings, LogMessageActions actions)
        {
            ...
            CreateSimpleLogFunc = createArgs =>
            {
                ...
                return new SimpleLog(createArgs.LogActions) { Category = tryFixCategory, EnabledLevel = simpleLogLevel };
            };
        }
        ...
        public Func<CreateSimpleLogArgs, ISimpleLog> CreateSimpleLogFunc { get; set; }

        public ISimpleLog Create(string category)
        {
            var args = new CreateSimpleLogArgs {Category = category, Settings = Settings, LogActions = LogActions};
            return CreateSimpleLogFunc(args);
        }
